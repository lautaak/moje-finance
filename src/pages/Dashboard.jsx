    ...
    return (
        <div className="p-4 pb-24 space-y-6 max-w-2xl mx-auto">
            ...
            <header className="flex justify-between items-center pt-4 px-1">
                <div>
                    <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-purple-600 tracking-tight">Přehled</h1>
                    <p className="text-gray-500 text-sm mt-0.5">Vítejte zpět</p>
                </div>
            </header>

            {/* Main Balance Card (Glassmorphism / Gradient) */}
            <div className="relative overflow-hidden rounded-3xl p-6 text-white shadow-xl shadow-blue-500/20 transform transition-transform active:scale-[0.98] duration-200">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                    <p className="text-blue-100 font-medium tracking-wide text-xs uppercase opacity-90">Celkový stav</p>
                    ...
                    {accounts?.map(account => (
                        <div key={account.id} className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm active:scale-95 transition-all">
                            <div className="flex items-start justify-between mb-2">
                                <div className="bg-blue-50/80 p-2 rounded-xl text-blue-600">
            ...
            <div>
                <div className="flex justify-between items-end mb-3 px-1">
                    ...
                    <Link to="/transactions" className="text-blue-600 text-xs font-bold hover:text-blue-700 bg-blue-50 px-3 py-1 rounded-full">Vše</Link>
                </div>
